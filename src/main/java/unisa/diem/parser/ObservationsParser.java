...
//TODO: Rimuovere o valorizzare commento inopportuno
//misurazione di un parametro, peso, altezza, glucosio,... ECG, anche se ti piace il cazzo.
    ...
    public void parseData() {
        ...
        for (CSVRecord record : records) {
            ...
            if (count % 100 == 0 || count == records.size()) {
                ...
                if (count % 1000 == 0)
                    datasetUtility.logInfo("Loaded %d observations", count);

                buffer.clear();
            }
        }

        datasetUtility.logInfo("Loaded ALL observations");
    }
}
